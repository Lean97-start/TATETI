"use strict"
    ...
    var cambioDeColor = document.getElementById('btn-jugar');
                        cambioDeColor.addEventListener('click', function(){
                            alert("asdfasdgdgshgfd");
                            cambioDeColor.style.background = "red";
                            cambioDeColor.style.textAlign = "center";
                            cambioDeColor.style.color = "white";
                        });
